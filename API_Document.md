...
- [Route](#route)
    ...
    - [PATCH /api/v1/routes (Update route info)](#patch-apiv1routes-update-route-info)
...
![itineraryX_ERD.jpg](https://raw.githubusercontent.com/xrchitron/itineraryX/main/server/public/img/itineraryX_ERD.jpg)
